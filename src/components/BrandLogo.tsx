  ...
  return (
    <div className={`flex items-center justify-center ${className}`} aria-label="SUTURA">
      <div
        ...
        className="flex items-center justify-center rounded-full bg-linear-to-br from-[#B99A6B] to-[#8A7063] text-white font-serif italic font-bold shadow-sm shrink-0"
      >
