...
export default function EditOperatingHoursModal({ isOpen, onClose, storeId, initialHours, onSaved }: EditOperatingHoursModalProps) {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await api.put(`/stores/${storeId}`, { operating_hours: hours });
